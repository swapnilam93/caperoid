...
public class PlayerControl : MonoBehaviour {
	...
	public AudioSource alcoholsound;
	...
	void OnTriggerEnter(Collider other)
	{
		if(other.gameObject.name == "Powerup(Clone)")
		{
			...
			Instantiate (powerup, gameObject.transform.position, other.transform.rotation);
			powerupsound.Play();
		}
		else if(other.gameObject.name == "Obstacle(Clone)")
		{
			control.AlcoholCollected();
			Instantiate (alcohol, other.transform.position, other.transform.rotation);
			alcoholsound.Play ();
		} 
