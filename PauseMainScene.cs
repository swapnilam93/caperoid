...
public class PauseMainScene : MonoBehaviour 
{
	...
	private void OnGUI()
	{
		...
		if (paused){    
			...
			if (GUI.Button(new Rect(Screen.width/4+10, Screen.height/4+2*Screen.height/10+10, Screen.width/2-20, Screen.height/10), "RESTART: 'Swipe Right'")){
